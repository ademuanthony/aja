...
import (
	...
	endpoint "github.com/ademuanthony/aja/notificator/pkg/endpoint"
	grpc "github.com/ademuanthony/aja/notificator/pkg/grpc"
	pb "github.com/ademuanthony/aja/notificator/pkg/grpc/pb"
...
func registerService(logger log.Logger) (*etcd.Registrar, error) {
	...
	registrar := etcd.NewRegistrar(client, etcd.Service{Key: key, Value:instance}, logger)
	registrar.Register()

	logger.Log("notificator register in etcd")
